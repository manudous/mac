...
export interface ManfredAwesomicCV {
  ...
  aboutMe: {
     ...
     */
    significativeRelationships?: [Person, ...Person[]];
    /**
  ...
  careerPreferences: {
    ...
    preferences?: {
       ...
       */
      preferredCompetences?: [Competence, ...Competence[]];
      /**
       * Skills, tools, domains or methodologies I don't like to work with
       */
      discardedCompetences?: [Competence, ...Competence[]];
      /**
       * Type of organizations where I want to work
       */
      preferredOrganizations?: [OrganizationType, ...OrganizationType[]];
      /**
       * Type of organizations where I don't want to work
       */
      discardedOrganizations?: [OrganizationType, ...OrganizationType[]];
      preferredRoles?: [string, ...string[]];
      /**
       * Type of roles I don't like to adopt
       */
      discardedRoles?: [string, ...string[]];
    };
    /**
